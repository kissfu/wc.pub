...
export const zh = defineConfig({
  ...
  themeConfig: {
    ...
    sidebar: {
      '/zh/navigation/': { base: '/zh/navigation/', items: sidebarNavigation() },
      '/zh/practice/': { base: '/zh/practice/', items: sidebarPractice() }
    },
    ...
    footer: {
      message: '基于 MIT 许可发布',
      copyright: `版权所有 © 2019-${new Date().getFullYear()} 王晓`
    },
